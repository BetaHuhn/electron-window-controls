...
To use [electron-vue-titlebar](https://github.com/BetaHuhn/electron-vue-titlebar), add it as a plugin to your Vuex store:

```js
import Vue from 'vue'
import Vuex from 'vuex'

import PersistedState from 'electron-vue-titlebar'
...
You can also pass an options object to `.create()` to customize the behaviour of [electron-vue-titlebar](https://github.com/BetaHuhn/electron-vue-titlebar) further:
...
Setting `dev` to true will stop [electron-vue-titlebar](https://github.com/BetaHuhn/electron-vue-titlebar) from persisting and rehydrating the state.
